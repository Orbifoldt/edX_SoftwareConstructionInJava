...
public class BigLibraryTest {
     ...
     *          the this last book should appear at the bottom and the first one should appear at usual place
    ...
    public void testFindBasicAndOrder() {
        ...
        Book book5 = new Book("ZZZ Harry Potter", Arrays.asList("J.K. Rowling"), 2000);
        Book book6 = new Book("AAA Harry Potter", Arrays.asList("J.K. Rowling"), 2000);
        library.buy(book1_4);
        library.buy(book4);
        library.buy(book6);
        library.buy(book5);
        library.buy(book1_2);
        library.buy(book1_3);
        assertEquals(library.find("Harry Potter"), Arrays.asList(book6,book1_4, book1_3, book1_2, book1,book5,book4));
    }
    ...
    public void testFindBeforeAfter() {
        Library library = new BigLibrary();
        Book book1_1 = new Book("Harry Potter", Arrays.asList("J.K. Rowling"), 1997);
        Book book1_2 = new Book("Harry Potter", Arrays.asList("J.K. Rowling"), 1998);
        Book book1_3 = new Book("Harry Potter", Arrays.asList("J.K. Rowling"), 1999);
        Book book1_4 = new Book("Harry Potter", Arrays.asList("J.K. Rowling"), 2001);
        library.buy(book1_1);
        ...
        // can be combined.
        assertEquals(library.find("Harry Potter AFTER 2000"), Arrays.asList(book1_4));
        assertEquals(library.find("Harry AFTER 1998 Potter"), Arrays.asList(book1_4, book1_3));
        assertEquals(library.find("Harry Potter BEFORE 2000"), Arrays.asList(book1_3, book1_2, book1_1));
        assertEquals(library.find("Harry BEFORE 1999 Potter"), Arrays.asList(book1_2, book1_1));
        assertEquals(library.find("AFTER 1997 Harry BEFORE 1999 Potter"), Arrays.asList(book1_2));
        // Wrong usage of BEFORE and AFTER does not give any errors:
    ...
    public void testFindQuotations() {
        Library library = new BigLibrary();
        Book book1 = new Book("Harry Potter", Arrays.asList("J.K. Rowling"), 1997);
        Book book2 = new Book("Azkaban", Arrays.asList("J.K.F. Rowling"), 1998);
        Book book3 = new Book("Harry and Potter", Arrays.asList("J.K.F. Rowling"), 2001);
        library.buy(book1);
        library.buy(book3);
        library.buy(book2);

        // Test quotation marks searches for exact matchings of the phrase inside the titles
        assertEquals(library.find("Harry Potter"), Arrays.asList(book1,book3)); // note the alphabetical ordering of titles
        assertEquals(library.find("\"Harry Potter\""), Arrays.asList(book1));
        // same for authors
        assertEquals(library.find("J.K. Rowling").size(), 3);
        assertEquals(library.find("\"J.K. Rowling\""), Arrays.asList(book1));
    }
    ...
    public void testFindNoCopiesAvailableOrder() {
        ...
        assertEquals(library.find("Harry Potter"), Arrays.asList(book1_4, book1_3, book1_2, book1_1));
        ...
        assertEquals(library.find("Harry Potter"), Arrays.asList(book1_4, book1_3, book1_1, book1_2));
        ...
        assertEquals(library.find("Harry Potter"), Arrays.asList(book1_3, book1_1, book1_4, book1_2));
