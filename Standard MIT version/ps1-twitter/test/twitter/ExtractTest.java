...
public class ExtractTest {
     ...
     * GetMentionedUsers:
     *
     * Partition: (*** not necessary by pre- and post-conditions, see MyExtractTest for those tests)
    ...
    public void testGetTimespanEmptyListZeroTime() {
        ...
        assertTrue("Assumed that starting time equals beginning",timespan.getStart() == timespan.getEnd());
    }
    ...
    public void testGetMentionedUsersTwoDifferentMentions() {
        ...
        String name1 = "henk";
        String name2 = "fr33";
        assertTrue("expected henk", mentionedUsers.contains(name1));
        assertTrue("expected fr33", mentionedUsers.contains(name2));
    }
    ...
    public void testGetMentionedUsersMultipleTweets() {
        ...
        String name1 = "abcdeabcde";
        String name2 = "fr33c";
        String name3 = "a";
        assertTrue("expected abcdeabcde", mentionedUsers.contains(name1));
        assertTrue("expected fr33c", mentionedUsers.contains(name2));
        assertTrue("expected a", mentionedUsers.contains(name3));
    }
